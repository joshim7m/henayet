      ...
      <div className="pt-[150px] min-h-[calc(100vh-80px)] py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold tracking-wide text-blue-600 dark:text-blue-400 uppercase mb-2">conferences</h2>
            <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white">Conference & Rewards</h1>
            <p className="text-slate-500 mt-2 text-sm">Click on any Image to view in full size</p>
          </div>
